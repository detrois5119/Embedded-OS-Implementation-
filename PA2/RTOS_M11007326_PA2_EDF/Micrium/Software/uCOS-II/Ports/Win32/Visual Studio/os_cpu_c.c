...
void  OSIntCtxSw (void)
{
    ...
    /*printf("%2d  task(%2d)   ", OSTimeGet(), OSPrioCur);
    if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0)
    {
        fprintf(Output_fp, "%2d  task(%2d)   ", OSTimeGet(), OSPrioCur);
        fclose(Output_fp);
    }
    ...
    */
    ...
    /*
    printf("    task(%2d)(%2d)    OSIntCtxSw ()\n", OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNum);
    if ((Output_err = fopen_s(&Output_fp, "./Output.txt", "a")) == 0)
    {
        fprintf(Output_fp, "    task(%2d)(%2d)    OSIntCtxSw ()\n", OSTCBCur->OSTCBId, OSTCBCur->OSTCBJobNum);
        fclose(Output_fp);
    }*/
}
