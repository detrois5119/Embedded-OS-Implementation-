...
#define AINPUT_FILE_NAME "./AperiodicJobs.txt"
...
#define INFO 4 //information of task
    ...
    int ATASK_NUMBER;        //Number of the input tasks
    int completeNumber;
    /*Task structure*/
    ...
    task_para_set ATaskParameter[OS_MAX_TASKS];
...
*/
    ...
    */
    ...
    typedef struct os_tcb {
        ...
        INT16U           OSTCBExecutionTime;
        INT16U           OSTCBArriveTime;
#endif
        ...
        INT16U           OSTCBPeriodic;
        INT16U           OSTCBDeadLine;
        INT16U           OSTCBContexSwitch;
        INT16U           OSTCBWorkTime;
        INT16U           OSTCBJobNum;            /* Task JobNum                                     */
        INT16U           OSTCBStartTime;
        INT16U           OSTCBCusUti;
#endif
